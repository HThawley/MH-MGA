...
class MOProblem:
    ...
    def step(
        ...
        mutation_sigma: float | tuple[float, float] = 0.1,  # std of gaussian noise (gets scaled automagically)
        ...
        termination_handler = term.MultiConvergence(criteria=[term.Maxiter(max_iter)] + convergence_criteria)
    ...
    def _display_progress(self):
        ...
        print(
            f"Iter: {self.current_iter}. Pareto front: {self.population.pareto.shape[0]}/{self.pareto_size}."
            f"Time: {elapsed}"
        )
